...
export function setAllTimeline() {
  ...
  sections.forEach((section) => {
    const timelineEl = section.querySelector(".career-timeline");
    const infoBoxes = section.querySelectorAll(".career-info-box");
    const dotEl = section.querySelector(".career-dot");
    ...
    sectionTimeline
      ...
      .fromTo(timelineEl, { opacity: 0 }, { opacity: 1, duration: 0.1 }, 0)
